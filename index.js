...
app.post("/getRooms", (req, res, next) => whoCanPass({ req, res, next, role: "user" }), RoomController.getRooms)
app.post("/getRoomsSupport", (req, res, next) => whoCanPass({ req, res, next, role: "user" }), RoomController.getRoomsSupport)